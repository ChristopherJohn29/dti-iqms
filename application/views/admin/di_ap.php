               ...
               <div class="modal-content">
                  ...
                  <form id="editDocumentedInformationForm">
                     ...
                     <div class="form-group col-md-12">
                           <label for="approval_for_publishing" class="form-label">Approval For Publishing</label>
                           <select class="form-select" id="approval_for_publishing" name="approval_for_publishing" required>
                              <option value=""></option>
